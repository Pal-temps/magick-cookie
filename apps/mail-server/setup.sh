...
echo ""
echo "  Compte : $USER"
echo "  IMAP   : mail.paltemps.fr:1993 (SSL self-signed)"
echo "  SMTP   : mail.paltemps.fr:1587 (STARTTLS)"
echo ""
echo "  Dans magick-cookie, utilisez le preset 'Self-hosted (paltemps.fr)'"
