...
function makeMockRepos() {
  return {
    ...
    triageRepo: { findAll: mock(() => Promise.resolve([])), findByStatus: mock(() => Promise.resolve([])), findByTaskId: mock(() => Promise.resolve(null)), upsert: mock(() => Promise.resolve({} as any)), bulkUpsert: mock(() => Promise.resolve()), deleteByTaskId: mock(() => Promise.resolve()), deleteAll: mock(() => Promise.resolve()), countByStatus: mock(() => Promise.resolve({})), countByDateRange: mock(() => Promise.resolve(0)) } as unknown as TriageRepository,
...
describe("AnalyticsService — Extended", () => {
  ...
  describe("getTimeByProject", () => {
    it("should group by projectId with project details", async () => {
      ...
      const svc = new AnalyticsService(repos.timerRepo, repos.dogWalkRepo, repos.wellnessLogRepo, repos.triageRepo, repos.emailRepo, repos.eventRepo, repos.taskRepo, projectRepo);
      (repos.timerRepo.findAll as any).mockReturnValue(Promise.resolve([
