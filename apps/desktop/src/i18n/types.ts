...
export interface Dictionary {
  ...
  settings: {
    ...
    devopsCliInstall: string;
    devopsCliUninstall: string;
    devopsCliInstalled: string;
    devopsCliVersion: string;
    devopsCliHomepage: string;
    devopsCliPhaseStarted: string;
    devopsCliPhaseDownloading: string;
    devopsCliPhaseVerifying: string;
    devopsCliPhaseExtracting: string;
    ...
    aiToolsTitle: string;
    aiToolsDesc: string;
    aiToolsSearch: string;
    aiToolsEnableAll: string;
    aiToolsDisableAll: string;
    aiToolsNoResults: string;
    aiToolsLoading: string;
    aiToolsSaved: string;
    aiToolsPermLevel: string;
    aiToolsPermAuto: string;
    aiToolsPermConfirm: string;
    aiToolsPermAdmin: string;
    aiToolsCategoryOther: string;
  ...
  firstRun: {
    ...
    gitCustom: string;
    gitRemoteUrl: string;
    gitRemotePlaceholder: string;
    gitConnectGithub: string;
    gitConnecting: string;
    gitConnected: string;
    gitWaitingCode: string;
    gitCodeLabel: string;
    gitOpenBrowser: string;
    gitlabUrl: string;
    gitlabToken: string;
    gitlabTokenHint: string;
    doneTitle: string;
    doneDesc: string;
    doneNotesDir: string;
    doneWorkspaceDir: string;
    doneGit: string;
    doneGitNone: string;
    start: string;
    next: string;
